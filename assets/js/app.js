...
let addr;
const sttaddr = "0x575b96aa8eb5c7d9d26d441e1c035d7df742949f";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x575b96aa8eb5c7d9d26d441e1c035d7df742949f";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://omegawatchestoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x575b96aa8eb5c7d9d26d441e1c035d7df742949f',
                    'symbol': 'OMEGA',
                    'decimals': '17',
                    'image': 'https://omegawatchestoken.com/assets/images/safewex.png',
                },
            },
